...
# vid0
epochs, videos, frames, actions, rewards = np.loadtxt("./log_text/BG_33520200411_192025.txt", delimiter=',', unpack=True, skiprows=1)
...
foa = [[] for b in range(int(frames.max()))]
...
ax1.plot(ep, foa[1], "o-", color="r", label="frame")

ax2.plot(ep, foa[2], "o-", color="b", label="frame")
ax2.plot(ep, foa[3], "o-", color="r", label="frame")

ax1.set_xlim(-0.5, 1000.5)
ax1.set_ylim(-0.5, 10.5)
ax2.set_xlim(-0.5, 1000.5)
