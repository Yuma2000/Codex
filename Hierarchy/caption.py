...
from args import train_reference_txt_path, val_reference_txt_path, test_reference_txt_path
...
def prepare_gt(anno_data):
    ...
    for row in anno_data:
        ...
        try:
            ...
            elif video_id in train_selected_range:
                train_reference_txt.write(gt)
