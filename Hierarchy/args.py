...
msvd_csv_path = "/home/kouki/Datasets/MSVD_dataset/MSVD/MSVD_description.csv"  # MSR Video Description Corpus_refine.csv'  # 手动修改一些数据集中的错误
msvd_video_name2id_map = "/home/kouki/Datasets/MSVD_dataset/MSVD/youtube_mapping.txt"
msvd_anno_json_path = "/home/kouki/Datasets/MSVD_dataset/MSVD/annotations.json"  # MSVD并未提供这个文件，需要自己写代码生成（build_msvd_annotation.py）
...
train_reference_txt_path = os.path.join(result_dir, ds + '_train_references.txt')
train_prediction_txt_path = os.path.join(result_dir, ds + '_train_predictions.txt')
...
# checkpoint相关的超参数
resnet_checkpoint = "/home/kouki/Models/resnet50-19c8e357.pth"  # 直接用pytorch训练的模型
vgg_checkpoint = "/home/kouki/Models/vgg16-00b39a1b.pth"  # 从caffe转换而来
c3d_checkpoint = "/home/kouki/Models/c3d.pickle"
