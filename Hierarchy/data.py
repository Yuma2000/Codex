...
def get_va_loader(cap_pkl, feature_h5, batch_size=200, shuffle=False, num_workers=1, pin_memory=False):
    v2d = V2TDataset(cap_pkl, feature_h5)
    data_loader = torch.utils.data.DataLoader(dataset=v2d,
                                              batch_size=batch_size,
                                              shuffle=shuffle,
                                              num_workers=num_workers,
                                              collate_fn=eval_collate_fn,
