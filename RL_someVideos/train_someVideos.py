...
txt_file1 = "Log_Text/" + video_name + "_key.txt"
txt_file2 = "Log_Text/" + video_name + "_key_final.txt"
txt_file3 = "Log_Text/" + video_name + "_key_epochs.txt"
txt_file4 = "Log_Text/" + video_name + "_key_videos.txt"
...
f1 = open(txt_file1, "w")
text1 = "Epoch" + "," + "Video" + "," + "Frame" + "," + "Action" + "," + "Reward" +"\n"
f1.writelines(text1)
...
# ファイルの読み込み
file_count = 0
for file_n in glob.glob("./Features/ThreeKeyVideos/*_features.h5"):
...
for view in range(views):
    ...
    max_frame_sum = 0
    video_counter = 0
    for feats_file in glob.glob("./Features/ThreeKeyVideos/*_features.h5"):
        ...
        for v_num, (videos_src, video_ids) in enumerate(feature):
            ...
            for frame in range(max_frame-1):
                ...
                #print("opt_end")
                log += 1
                text1 = str(view) + "," + str(video_counter) + "," + str(frame) + "," + str(action.item()) + "," + str(reward.item()) + "\n"
                f1.writelines(text1)
        
            # 各映像ごとの報酬
            video_sum_reward = video_sum_reward / (max_frame - 1)
            text4 = str(view) + "," + str(video_counter) + "," + str(reward.item()) + "\n"
            f4.writelines(text4)
    ...
    sum_reward = sum_reward / (mfs-file_count)
    text3 = str(view) + "," + str(sum_reward.item()) + "\n"
    f3.writelines(text3)
    #print(sum_reward)
...
reinf_ave = reinf_sum / (views-reinf_num)
print(reinf_max)      
