...
max_frame = 0
dtype = torch.float
txt_file1 = "text_file/2LSTM/" + video_name +"_2LSTM"+ "_key.txt"
txt_file2 = "text_file/2LSTM/" + video_name +"_2LSTM"+ "_final_key" + ".txt"
txt_file3 = "text_file/2LSTM/" + video_name +"_2LSTM"+ "_best_action" + ".txt"
...
MODEL_PATH1 = './LSTM_model/LSTM_AutoEncoder_2LSTM_Epoch_10000_lr_1e-5.pth'
